...
<div class="outer-wrapper">
  ...
  <header id="header" class="header">
    ...
    <div class="header-inner">
      <?php if ($logo): ?>
        <div class="logo">
          <h1><?php print t('Western concepts'); ?></h1>
      ...
      <div class="card">
        <figure>
          <img src="<?php print base_path() . drupal_get_path("theme", "wcportal_mobile"); ?>/images/tmp/img-card@2.png" alt="">
          <figcaption>
            <a href="<?php print url("shop");?>">
              <?php print t("Learn about our");?>
              <span><?php print t("Gift Cards");?></span>
            </a>
          </figcaption>
        </figure>
      </div>
