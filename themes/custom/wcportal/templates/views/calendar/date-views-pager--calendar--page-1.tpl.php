...
<div class="date-nav-wrapper clearfix<?php if (!empty($extra_classes)) print $extra_classes; ?>">
  <div class="date-nav item-list">
    ...
    <?php if (!empty($prev_url)) : ?>
      <li class="date-prev">
        <?php print l(($mini ? '' : ' ' . t('Previous month', array(), array('context' => 'date_nav'))), $prev_url, $prev_options); ?>
      </li>
    <?php endif; ?>
    <?php if (!empty($next_url)) : ?>
      <li class="date-next">
        <?php print l(($mini ? '' : t('Next month', array(), array('context' => 'date_nav')) . ' '), $next_url, $next_options); ?>
      </li>
    <?php endif; ?>
    </ul>
  </div>
